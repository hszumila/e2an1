...
int main(){
 ...
 //Read in data files
  ...
  double mom_x  [20], mom_y    [20], mom_z  [20], Mass   [20], charge[20], beta[20], vtx_z_cor[20],
    ...
    ec_u   [20], ec_v     [20], ec_w   [20], vtx_z_uncor[20], theta[20], phi[20];
  ...
  t->SetBranchAddress("vtx_z_unc" , vtx_z_uncor );
  ...
  h1_u_eppn->GetXaxis()->SetTitleSize(0.07); h1_u_eppn->GetXaxis()->SetTitleOffset(0.6);
  TH1D * h1_v_eppn        = new TH1D("h1_v_eppn"     ,"^{3}He(e,e'ppn);EC_{v} [cm];Counts"                 ,100,   0., 500.);
  h1_v_eppn->GetXaxis()->SetTitleSize(0.07); h1_v_eppn->GetXaxis()->SetTitleOffset(0.6);
  TH1D * h1_w_eppn        = new TH1D("h1_w_eppn"     ,"^{3}He(e,e'ppn);EC_{w} [cm];Counts"                 ,100,   0., 500.);
  h1_w_eppn->GetXaxis()->SetTitleSize(0.07); h1_w_eppn->GetXaxis()->SetTitleOffset(0.6);
  TH1D * h1_u_eppn_cut    = new TH1D("h1_u_eppn_cut" ,"^{3}He(e,e'ppn);EC_{u} [cm];Counts"                 ,100,   0., 500.);
  h1_u_eppn_cut->GetXaxis()->SetTitleSize(0.07); h1_u_eppn_cut->GetXaxis()->SetTitleOffset(0.6);
  TH1D * h1_v_eppn_cut    = new TH1D("h1_v_eppn_cut" ,"^{3}He(e,e'ppn);EC_{v} [cm];Counts"                 ,100,   0., 500.);
  h1_v_eppn_cut->GetXaxis()->SetTitleSize(0.07); h1_v_eppn_cut->GetXaxis()->SetTitleOffset(0.6);
  TH1D * h1_w_eppn_cut    = new TH1D("h1_w_eppn_cut" ,"^{3}He(e,e'ppn);EC_{w} [cm];Counts"                 ,100,   0., 500.);
  h1_w_eppn_cut->GetXaxis()->SetTitleSize(0.07); h1_w_eppn_cut->GetXaxis()->SetTitleOffset(0.6);
  ...
  h1_u_eppnpipi->GetXaxis()->SetTitleSize(0.07); h1_u_eppnpipi->GetXaxis()->SetTitleOffset(0.6);
  TH1D * h1_v_eppnpipi     = new TH1D("h1_v_eppnpipi"     ,"^{3}He(e,e'ppn#pi^{+}#pi^{-});EC_{v} [cm];Counts"  ,100,   0., 500.);
  h1_v_eppnpipi->GetXaxis()->SetTitleSize(0.07); h1_v_eppnpipi->GetXaxis()->SetTitleOffset(0.6);
  TH1D * h1_w_eppnpipi     = new TH1D("h1_w_eppnpipi"     ,"^{3}He(e,e'ppn#pi^{+}#pi^{-});EC_{w} [cm];Counts"  ,100,   0., 500.);
  h1_w_eppnpipi->GetXaxis()->SetTitleSize(0.07); h1_w_eppnpipi->GetXaxis()->SetTitleOffset(0.6);
  TH1D * h1_u_eppnpipi_cut = new TH1D("h1_u_eppnpipi_cut" ,"^{3}He(e,e'ppn#pi^{+}#pi^{-});EC_{u} [cm];Counts"  ,100,   0., 500.);
  h1_u_eppnpipi_cut->GetXaxis()->SetTitleSize(0.07); h1_u_eppnpipi_cut->GetXaxis()->SetTitleOffset(0.6);
  TH1D * h1_v_eppnpipi_cut = new TH1D("h1_v_eppnpipi_cut" ,"^{3}He(e,e'ppn#pi^{+}#pi^{-});EC_{v} [cm];Counts"  ,100,   0., 500.);
  h1_v_eppnpipi_cut->GetXaxis()->SetTitleSize(0.07); h1_v_eppnpipi_cut->GetXaxis()->SetTitleOffset(0.6);
  TH1D * h1_w_eppnpipi_cut = new TH1D("h1_w_eppnpipi_cut" ,"^{3}He(e,e'ppn#pi^{+}#pi^{-});EC_{w} [cm];Counts"  ,100,   0., 500.);
  h1_w_eppnpipi_cut->GetXaxis()->SetTitleSize(0.07); h1_w_eppnpipi_cut->GetXaxis()->SetTitleOffset(0.6);
  ...
  h1_M_miss_eppn->GetXaxis()->SetTitleSize(0.07); h1_M_miss_eppn->GetXaxis()->SetTitleOffset(0.6);
  h1_M_miss_eppn_cut->GetXaxis()->SetTitleSize(0.07); h1_M_miss_eppn_cut->GetXaxis()->SetTitleOffset(0.6);
  // ---
  ...
  h1_M_miss_eppnpipi->GetXaxis()->SetTitleSize(0.07); h1_M_miss_eppnpipi->GetXaxis()->SetTitleOffset(0.6);
  h1_M_miss_eppnpipi_cut->GetXaxis()->SetTitleSize(0.07); h1_M_miss_eppnpipi_cut->GetXaxis()->SetTitleOffset(0.6);
  // -----------------------------------
  // Pmiss cut
  ...
  h1_P_miss_eppn->GetXaxis()->SetTitleSize(0.07); h1_P_miss_eppn->GetXaxis()->SetTitleOffset(0.6);
  h1_P_miss_eppn_cut->GetXaxis()->SetTitleSize(0.07); h1_P_miss_eppn_cut->GetXaxis()->SetTitleOffset(0.6);
  // ---
  ...
  h1_P_miss_eppnpipi->GetXaxis()->SetTitleSize(0.07); h1_P_miss_eppnpipi->GetXaxis()->SetTitleOffset(0.6);
  h1_P_miss_eppnpipi_cut->GetXaxis()->SetTitleSize(0.07); h1_P_miss_eppnpipi_cut->GetXaxis()->SetTitleOffset(0.6);
  // -----------------------------------
  // Vertex difference cut
  TH1F *h1_delta_vz_e_p1    = new TH1F("h1_delta_vz_e_p1"   ,"#Delta v_{Z};e - p1;Counts"     , 50,  -5., 5. ); h1_delta_vz_e_p1->GetXaxis()->SetTitleSize(0.07); h1_delta_vz_e_p1->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_delta_vz_e_p2    = new TH1F("h1_delta_vz_e_p2"   ,"#Delta v_{Z};e - p2;Counts"     , 50,  -5., 5. ); h1_delta_vz_e_p2->GetXaxis()->SetTitleSize(0.07); h1_delta_vz_e_p2->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_delta_vz_p1_p2   = new TH1F("h1_delta_vz_p1_p2"  ,"#Delta v_{Z};p1 - p2;Counts"    , 50,  -5., 5. ); h1_delta_vz_p1_p2->GetXaxis()->SetTitleSize(0.07); h1_delta_vz_p1_p2->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_delta_vz_e_pip   = new TH1F("h1_delta_vz_e_pip"  ,"#Delta v_{Z};e - pi+;Counts"    , 50,  -5., 5. ); h1_delta_vz_e_pip->GetXaxis()->SetTitleSize(0.07); h1_delta_vz_e_pip->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_delta_vz_e_pim   = new TH1F("h1_delta_vz_e_pim"  ,"#Delta v_{Z};e - pi-;Counts"    , 50,  -5., 5. ); h1_delta_vz_e_pim->GetXaxis()->SetTitleSize(0.07); h1_delta_vz_e_pim->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_delta_vz_pip_pim = new TH1F("h1_delta_vz_pip_pim","#Delta v_{Z};pi+ - pi-;Counts"  , 50,  -5., 5. ); h1_delta_vz_pip_pim->GetXaxis()->SetTitleSize(0.07); h1_delta_vz_pip_pim->GetXaxis()->SetTitleOffset(0.6);
  // ---
  ...
  h1_max_vz_sig_eppn->GetXaxis()->SetTitleSize(0.07); h1_max_vz_sig_eppn->GetXaxis()->SetTitleOffset(0.6);
  h1_max_vz_sig_eppn_cut->GetXaxis()->SetTitleSize(0.07); h1_max_vz_sig_eppn_cut->GetXaxis()->SetTitleOffset(0.6);
  // ---
  ...
  h1_max_vz_sig_eppnpipi->GetXaxis()->SetTitleSize(0.07); h1_max_vz_sig_eppnpipi->GetXaxis()->SetTitleOffset(0.6);
  h1_max_vz_sig_eppnpipi_cut->GetXaxis()->SetTitleSize(0.07); h1_max_vz_sig_eppnpipi_cut->GetXaxis()->SetTitleOffset(0.6);
  // -----------------------------------
  // Beta cut
  ...
  h1_beta_eppn->GetXaxis()->SetTitleSize(0.07); h1_beta_eppn->GetXaxis()->SetTitleOffset(0.6);
  h1_beta_eppn_cut->GetXaxis()->SetTitleSize(0.07); h1_beta_eppn_cut->GetXaxis()->SetTitleOffset(0.6);
  // ---
  ...
  h1_beta_eppnpipi->GetXaxis()->SetTitleSize(0.07); h1_beta_eppnpipi->GetXaxis()->SetTitleOffset(0.6);
  h1_beta_eppnpipi_cut->GetXaxis()->SetTitleSize(0.07); h1_beta_eppnpipi_cut->GetXaxis()->SetTitleOffset(0.6);
  // -----------------------------------
  // cos( miss , ec ) cut
  ...
  h1_cos_miss_ec_eppn->GetXaxis()->SetTitleSize(0.07); h1_cos_miss_ec_eppn->GetXaxis()->SetTitleOffset(0.6);
  h1_cos_miss_ec_eppn_cut->GetXaxis()->SetTitleSize(0.07); h1_cos_miss_ec_eppn_cut->GetXaxis()->SetTitleOffset(0.6);
  // ---
  ...
  h1_cos_miss_ec_eppnpipi->GetXaxis()->SetTitleSize(0.07); h1_cos_miss_ec_eppnpipi->GetXaxis()->SetTitleOffset(0.6);
  h1_cos_miss_ec_eppnpipi_cut->GetXaxis()->SetTitleSize(0.07); h1_cos_miss_ec_eppnpipi_cut->GetXaxis()->SetTitleOffset(0.6);
  // -----------------------------------
  
  TH1F * h1_pmiss_epp        = new TH1F("h1_pmiss_epp"        , "^{3}He(e,e'pp)n;p_{miss} [GeV];Counts"                 , 10 , 0.5 , 2.1 );
  h1_pmiss_epp->GetXaxis()->SetTitleSize(0.07); h1_pmiss_epp->GetXaxis()->SetTitleOffset(0.6);
  TH1F * h1_pmiss_epppipi    = new TH1F("h1_pmiss_epppipi"    , "^{3}He(e,e'pp#pi^{+}#pi^{-})n;p_{miss} [GeV];Counts"   , 10 , 0.5 , 2.1 );
  h1_pmiss_epppipi->GetXaxis()->SetTitleSize(0.07); h1_pmiss_epppipi->GetXaxis()->SetTitleOffset(0.6);
  TH1F * h1_pmiss_both_inc   = new TH1F("h1_pmiss_both_inc"   , "both, inclusive;p_{miss} [GeV];Counts"                 , 10 , 0.5 , 2.1 );
  h1_pmiss_both_inc->GetXaxis()->SetTitleSize(0.07); h1_pmiss_both_inc->GetXaxis()->SetTitleOffset(0.6);

  TH1F * h1_pmiss_epp_corr        = new TH1F("h1_pmiss_epp_corr"        , "^{3}He(e,e'pp)n;p_{miss} [GeV];Counts"                 , 10 , 0.5 , 2.1 );
  h1_pmiss_epp_corr->GetXaxis()->SetTitleSize(0.07); h1_pmiss_epp_corr->GetXaxis()->SetTitleOffset(0.6);
  TH1F * h1_pmiss_epppipi_corr    = new TH1F("h1_pmiss_epppipi_corr"    , "^{3}He(e,e'pp#pi^{+}#pi^{-})n;p_{miss} [GeV];Counts"   , 10 , 0.5 , 2.1 );
  h1_pmiss_epppipi_corr->GetXaxis()->SetTitleSize(0.07); h1_pmiss_epppipi_corr->GetXaxis()->SetTitleOffset(0.6);
  TH1F * h1_pmiss_both_inc_corr   = new TH1F("h1_pmiss_both_inc_corr"   , "both, inclusive;p_{miss} [GeV];Counts"                 , 10 , 0.5 , 2.1 );
  h1_pmiss_both_inc_corr->GetXaxis()->SetTitleSize(0.07); h1_pmiss_both_inc_corr->GetXaxis()->SetTitleOffset(0.6);
  
  TH1F * h1_pmiss_eppn       = new TH1F("h1_pmiss_eppn"       , "^{3}He(e,e'ppn);p_{miss} [GeV];Counts"                 , 10 , 0.5 , 2.1 );
  h1_pmiss_eppn->GetXaxis()->SetTitleSize(0.07); h1_pmiss_eppn->GetXaxis()->SetTitleOffset(0.6);
  TH1F * h1_pmiss_epppipin   = new TH1F("h1_pmiss_epppipin"   , "^{3}He(e,e'pp#pi^{+}#pi^{-}n);p_{miss} [GeV];Counts"   , 10 , 0.5 , 2.1 );
  h1_pmiss_epppipin->GetXaxis()->SetTitleSize(0.07); h1_pmiss_epppipin->GetXaxis()->SetTitleOffset(0.6);
  TH1F * h1_pmiss_both_exc   = new TH1F("h1_pmiss_both_exc"   , "both, exclusive;p_{miss} [GeV];Counts"                 , 10 , 0.5 , 2.1 );
  h1_pmiss_both_exc->GetXaxis()->SetTitleSize(0.07); h1_pmiss_both_exc->GetXaxis()->SetTitleOffset(0.6);

  TH1F * h1_det_eff_eppn     = new TH1F("h1_det_eff_eppn"     , ";p_{miss} [GeV]"                                                      , 10 , 0.5 , 2.1 );
  h1_det_eff_eppn->GetXaxis()->SetTitleSize(0.07); h1_det_eff_eppn->GetXaxis()->SetTitleOffset(0.6);
  TH1F * h1_det_eff_eppnpipi = new TH1F("h1_det_eff_eppnpipi" , ";p_{miss} [GeV]"                                                      , 10 , 0.5 , 2.1 );
  h1_det_eff_eppnpipi->GetXaxis()->SetTitleSize(0.07); h1_det_eff_eppnpipi->GetXaxis()->SetTitleOffset(0.6);
  TH1F * h1_det_eff_both     = new TH1F("h1_det_eff_both"     , ";p_{miss} [GeV]"                                                      , 10 , 0.5 , 2.1 );
  h1_det_eff_both->GetXaxis()->SetTitleSize(0.07); h1_det_eff_both->GetXaxis()->SetTitleOffset(0.6);

  TH1F * h1_det_eff_eppn_corr     = new TH1F("h1_det_eff_eppn_corr"     , ";p_{miss} [GeV]"                                                      , 10 , 0.5 , 2.1 );
  h1_det_eff_eppn_corr->GetXaxis()->SetTitleSize(0.07); h1_det_eff_eppn_corr->GetXaxis()->SetTitleOffset(0.6);
  TH1F * h1_det_eff_eppnpipi_corr = new TH1F("h1_det_eff_eppnpipi_corr" , ";p_{miss} [GeV]"                                                      , 10 , 0.5 , 2.1 );
  h1_det_eff_eppnpipi_corr->GetXaxis()->SetTitleSize(0.07); h1_det_eff_eppnpipi_corr->GetXaxis()->SetTitleOffset(0.6);
  TH1F * h1_det_eff_both_corr     = new TH1F("h1_det_eff_both_corr"     , ";p_{miss} [GeV/c];neutron detection efficiency"                                                      , 10 , 0.5 , 2.1 );
  h1_det_eff_both_corr->GetXaxis()->SetTitleSize(0.045); h1_det_eff_both_corr->GetXaxis()->SetTitleOffset(0.65);
  h1_det_eff_both_corr->GetYaxis()->SetTitleSize(0.045); h1_det_eff_both_corr->GetYaxis()->SetTitleOffset(0.65);

  TH1F *h1_Mmiss_eppn_inc0 = new TH1F("h1_Mmiss_eppn_inc0","0.5<p_{miss}<1 GeV;m_{miss} [GeV]",30,0.4,1.4);
  h1_Mmiss_eppn_inc0->GetXaxis()->SetTitleSize(0.07); h1_Mmiss_eppn_inc0->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_Mmiss_eppn_inc1 = new TH1F("h1_Mmiss_eppn_inc1","1<p_{miss}<1.5 GeV;m_{miss} [GeV]",30,0.4,1.4);
  h1_Mmiss_eppn_inc1->GetXaxis()->SetTitleSize(0.07); h1_Mmiss_eppn_inc1->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_Mmiss_eppn_inc2 = new TH1F("h1_Mmiss_eppn_inc2","1.5<p_{miss}<2.1 GeV;m_{miss} [GeV]",30,0.4,1.4);
  h1_Mmiss_eppn_inc2->GetXaxis()->SetTitleSize(0.07); h1_Mmiss_eppn_inc2->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_Mmiss_eppn_exc0 = new TH1F("h1_Mmiss_eppn_exc0","0.5<p_{miss}<1 GeV;m_{miss} [GeV]",30,0.4,1.4);
  h1_Mmiss_eppn_exc0->GetXaxis()->SetTitleSize(0.07); h1_Mmiss_eppn_exc0->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_Mmiss_eppn_exc1 = new TH1F("h1_Mmiss_eppn_exc1","1<p_{miss}<1.5 GeV;m_{miss} [GeV]",30,0.4,1.4);
  h1_Mmiss_eppn_exc1->GetXaxis()->SetTitleSize(0.07); h1_Mmiss_eppn_exc1->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_Mmiss_eppn_exc2 = new TH1F("h1_Mmiss_eppn_exc2","1.5<p_{miss}<2.1 GeV;m_{miss} [GeV]",30,0.4,1.4);
  h1_Mmiss_eppn_exc2->GetXaxis()->SetTitleSize(0.07); h1_Mmiss_eppn_exc2->GetXaxis()->SetTitleOffset(0.6);


  TH1F *h1_Mmiss_eppin_inc0 = new TH1F("h1_Mmiss_eppin_inc0","0.5<p_{miss}<1.2 GeV;m_{miss} [GeV]",30,0.4,1.4);
  h1_Mmiss_eppin_inc0->GetXaxis()->SetTitleSize(0.07); h1_Mmiss_eppin_inc0->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_Mmiss_eppin_inc1 = new TH1F("h1_Mmiss_eppin_inc1","1.2<p_{miss}<2.1 GeV;m_{miss} [GeV]",30,0.4,1.4);
  h1_Mmiss_eppin_inc1->GetXaxis()->SetTitleSize(0.07); h1_Mmiss_eppin_inc1->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_Mmiss_eppin_exc0 = new TH1F("h1_Mmiss_eppin_exc0","0.5<p_{miss}<1.2 GeV;m_{miss} [GeV]",30,0.4,1.4);
  h1_Mmiss_eppin_exc0->GetXaxis()->SetTitleSize(0.07); h1_Mmiss_eppin_exc0->GetXaxis()->SetTitleOffset(0.6);
  TH1F *h1_Mmiss_eppin_exc1 = new TH1F("h1_Mmiss_eppin_exc1","1.2<p_{miss}<2.1 GeV;m_{miss} [GeV]",30,0.4,1.4);
  h1_Mmiss_eppin_exc1->GetXaxis()->SetTitleSize(0.07); h1_Mmiss_eppin_exc1->GetXaxis()->SetTitleOffset(0.6);
  ...
  TH2F *h2_delta_vz_pip_pim = new TH2F("h2_delta_vz_pip_pim",";#Delta v_{Z} (unc);#Delta v_{Z} (cor)"  , 50,  -5., 5., 50,-5,5 ); 
  TH2F *h2_delta_vz_pip = new TH2F("h2_delta_vz_pip",";#Delta v_{Z} (cor);pip v unc"  , 50,  -5., 5., 50,-10,10 ); 
  TH2F *h2_delta_vz_pim = new TH2F("h2_delta_vz_pim",";#Delta v_{Z} (cor);pim v unc"  , 50,  -5., 5., 50,-10,10 ); 
  TH2F *h2_delta_vz_pim_theta = new TH2F("h2_delta_vz_pim_theta",";#Delta v_{Z} (cor);pim theta"  , 50,  -5., 5., 50,0,100 ); 
  TH2F *h2_delta_vz_pip_theta = new TH2F("h2_delta_vz_pip_theta",";#Delta v_{Z} (cor);pip theta"  , 50,  -5., 5., 50,0,100 ); 
  TH2F *h2_delta_vz_pim_phi = new TH2F("h2_delta_vz_pim_phi",";#Delta v_{Z} (cor);pim phi"  , 50,  -5., 5., 50,0,360 ); 
  TH2F *h2_delta_vz_pip_phi = new TH2F("h2_delta_vz_pip_phi",";#Delta v_{Z} (cor);pip phi"  , 50,  -5., 5., 50,-100,100 ); 
  TH2F *h2_delta_vz_pipP = new TH2F("h2_delta_vz_pipP",";#Delta v_{Z} (cor);pip P"  , 50,  -5., 5., 50,0,2 ); 
  TH2F *h2_delta_vz_pimP = new TH2F("h2_delta_vz_pimP",";#Delta v_{Z} (cor);pim P"  , 50,  -5., 5., 50,0,2 ); 
  ...
  for(int evt=0;evt<nEntries;evt++){
    ...
    if((pip!=0)&&(pim!=0)){
      h1_delta_vz_e_pip   -> Fill(vtx_z_cor[  0]-vtx_z_uncor[pip]);
      h1_delta_vz_e_pim   -> Fill(vtx_z_cor[  0]-vtx_z_uncor[pim]);
      h1_delta_vz_pip_pim -> Fill(vtx_z_uncor[pip]-vtx_z_uncor[pim]); 
      //cout<<"diff cor: "<<vtx_z_cor[pip]-vtx_z_cor[pim]<<" diff uncor: "<<vtx_z_uncor[pip]-vtx_z_uncor[pim]<<endl;
      //cout<<"    pip: "<<pip<<" pim: "<<pim<<endl;
      //cout<<"    pip uncor: "<<vtx_z_uncor[pip]<<" pip cor:"<<vtx_z_cor[pip]<<" pim uncor: "<<vtx_z_uncor[pim]<< "pim cor: "<<vtx_z_cor[pim]<<endl;
      //cout<<"    pip theta: "<<theta[pip]<<" pim theta:"<<theta[pim]<<" pim phi: "<<phi[pim]<< " pip phi: "<<phi[pip]<<endl;
      
      h2_delta_vz_pip_pim->Fill(vtx_z_uncor[pip]-vtx_z_uncor[pim],vtx_z_cor[pip]-vtx_z_cor[pim]);
      h2_delta_vz_pip->Fill(vtx_z_cor[pip]-vtx_z_cor[pim], vtx_z_uncor[pip]); 
      h2_delta_vz_pim->Fill(vtx_z_cor[pip]-vtx_z_cor[pim], vtx_z_uncor[pim]); 
      h2_delta_vz_pim_theta->Fill(vtx_z_cor[pip]-vtx_z_cor[pim], theta[pim]);  
      h2_delta_vz_pip_theta->Fill(vtx_z_cor[pip]-vtx_z_cor[pim], theta[pip]);  
      h2_delta_vz_pim_phi->Fill(vtx_z_cor[pip]-vtx_z_cor[pim], phi[pim]);
      h2_delta_vz_pip_phi->Fill(vtx_z_cor[pip]-vtx_z_cor[pim], phi[pip]); 
      h2_delta_vz_pipP->Fill(vtx_z_cor[pip]-vtx_z_cor[pim],sqrt(pow(mom_x[pip],2.)+pow(mom_y[pip],2)+pow(mom_z[pip],2)));
      h2_delta_vz_pimP->Fill(vtx_z_cor[pip]-vtx_z_cor[pim],sqrt(pow(mom_x[pim],2.)+pow(mom_y[pim],2)+pow(mom_z[pim],2)));
  ...
  for(int evt=0;evt<nEntries;evt++){
    ...
    Z_e_p2_abs    = TMath::Abs(vtx_z_cor[  0]-vtx_z_cor[ p2])/sig_e_p2   ;
    Z_p1p2_abs    = TMath::Abs(vtx_z_cor[ p1]-vtx_z_cor[ p2])/sig_p1p2   ;
    Z_e_pip_abs   = TMath::Abs(vtx_z_cor[  0]-vtx_z_uncor[pip])/sig_e_pip  ;
    Z_e_pim_abs   = TMath::Abs(vtx_z_cor[  0]-vtx_z_uncor[pim])/sig_e_pim  ;
    Z_pip_pim_abs = TMath::Abs(vtx_z_uncor[pip]-vtx_z_uncor[pim])/sig_pip_pim;
  ...
  TPaveText *pt0 = new TPaveText(.4,50,0.8,100);
  ...
  TPaveText *pt1 = new TPaveText(.4,15,0.8,25);
  ...
  TPaveText *pt2 = new TPaveText(.4,10,0.8,20);
  ...
  TPaveText *pt0pi = new TPaveText(.4,10,0.8,20);
  ...
  TPaveText *pt1pi = new TPaveText(.4,5,0.8,8);
  ...
  h1_det_eff_both_corr     -> SetTitle("Combined neutron detection efficiency, background corrected"                       );
  
  h1_det_eff_eppn     -> GetYaxis() -> SetTitle("neut. det. eff."); h1_det_eff_eppn     -> GetYaxis() -> SetTitleSize(0.07);h1_det_eff_eppn     -> GetYaxis() -> SetTitleOffset(0.5);
  h1_det_eff_eppn_corr     -> GetYaxis() -> SetTitle("neut. det. eff.");h1_det_eff_eppn_corr     -> GetYaxis() -> SetTitleSize(0.07);h1_det_eff_eppn_corr     -> GetYaxis() -> SetTitleOffset(0.5);
  h1_det_eff_eppnpipi -> GetYaxis() -> SetTitle("neut. det. eff.");h1_det_eff_eppnpipi     -> GetYaxis() -> SetTitleSize(0.07);h1_det_eff_eppnpipi     -> GetYaxis() -> SetTitleOffset(0.5);
  h1_det_eff_eppnpipi_corr -> GetYaxis() -> SetTitle("neut. det. eff.");h1_det_eff_eppnpipi_corr     -> GetYaxis() -> SetTitleSize(0.07);h1_det_eff_eppnpipi_corr     -> GetYaxis() -> SetTitleOffset(0.5);
  h1_det_eff_both     -> GetYaxis() -> SetTitle("neut. det. eff.");h1_det_eff_both     -> GetYaxis() -> SetTitleSize(0.07);h1_det_eff_both     -> GetYaxis() -> SetTitleOffset(0.5);
  h1_det_eff_both_corr     -> GetYaxis() -> SetTitle("neutron detection efficiency");h1_det_eff_both_corr     -> GetYaxis() -> SetTitleSize(0.045);h1_det_eff_both_corr     -> GetYaxis() -> SetTitleOffset(0.65);
  h1_det_eff_both_corr->GetXaxis()->SetTitleOffset(0.8);
  ...
  TCanvas *c7 = new TCanvas("c7","Space oddity",1200,900);
  c7 -> Divide(4,2);
  c7->cd(1); h2_delta_vz_pip_pim->Draw("colz");
  c7->cd(2); h2_delta_vz_pip->Draw("colz");
  c7->cd(3); h2_delta_vz_pim->Draw("colz");
  c7->cd(4); h2_delta_vz_pim_theta->Draw("colz");
  c7->cd(5); h2_delta_vz_pip_theta->Draw("colz");
  c7->cd(6); h2_delta_vz_pim_phi->Draw("colz");
  c7->cd(7); h2_delta_vz_pip_phi->Draw("colz");
  c7->Print(outputpdf+".pdf(");
  
  TCanvas *c8 = new TCanvas("c8","Space oddity",1200,900);
  c8 -> Divide(2,1);
  c8->cd(1); h2_delta_vz_pipP->Draw("colz");
  c8->cd(2); h2_delta_vz_pimP->Draw("colz");
  c8->Print(outputpdf+".pdf(");

  TCanvas *c9 = new TCanvas("c9","neutron eff alone",1200,900);
  c9->cd(); h1_det_eff_both_corr     -> Draw("");
  fit_gfunctionEG2( h1_det_eff_both_corr,0.5,2.1);
