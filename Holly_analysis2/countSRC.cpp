...
int main(){
  ...
  TFile *fout = new TFile("output/out_SRC_scratch.root","RECREATE");
  ...
  //canvas->SetLogy();
  std::string pdf_file_name = "output/out_SRC_scratch.pdf";
  gROOT->SetBatch(true);
  gStyle->SetOptStat(0);
  ...
  for (int ii=0;ii<3;ii++){
    ...
    for(int jj=0;jj<3;jj++){
      h_emom[ii][jj]=new TH1F(Form("h_emom_%i_%i",ii,jj),";P_{e-} [GeV/c] (with lead cuts);",nbin,0,6); 
      h_etheta[ii][jj]=new TH1F(Form("h_etheta_%i_%i",ii,jj),";#theta_{e-} [deg] (with lead cuts);",nbin,0,45);
      h_q2[ii][jj]=new TH1F(Form("h_q2_%i_%i",ii,jj),";Q^{2} (with lead cuts);",nbin,0,6);
      h_nu[ii][jj]=new TH1F(Form("h_nu_%i_%i",ii,jj),";#nu [GeV] (with lead cuts);",nbin,0,3);
      h_xb[ii][jj]=new TH1F(Form("h_xb_%i_%i",ii,jj),";x_{B} (with lead cuts);",nbin,0,2);
      h_pmiss[ii][jj]=new TH1F(Form("h_pmiss_%i_%i",ii,jj),";P_{miss} [GeV/c];",nbin,0,1.5);
      h_emVpm[ii][jj]=new TH2F(Form("h_emVpm_%i_%i",ii,jj),";pmiss;emiss",50,0,0.8,50,-0.5,0.5);
      h_thetapq[ii][jj]=new TH1F(Form("h_thetapq_%i_%i",ii,jj),";#theta_{lead N/q} [deg];",nbin,0,25);
      h_nmom[ii][jj]=new TH1F(Form("h_nmom_%i_%i",ii,jj),";P_{lead N} [GeV/c];",nbin,0,3);
      h_ntheta[ii][jj]=new TH1F(Form("h_ntheta_%i_%i",ii,jj),";#theta_{lead N} [deg];",nbin,0,90);
      h_emiss[ii][jj]= new TH1D(Form("h_emiss_%i_%i",ii,jj),";missing energy",nbin,-1,2);
      h_mmiss[ii][jj]= new TH1D(Form("h_mmiss_%i_%i",ii,jj),";missing mass [GeV/c^{2}]",nbin,0,3);
    }
  }
   ...
   for (int event =0 ; event < intree->GetEntries() ; event++)
       ...
       if (leadingID > 0)
 	{
 	 ...
 	 //select the 3He proton sample
 		  if (p_over_q>pq_min && p_over_q<pq_max_p && mmiss<mmiss_nomCut && xB>xb_cut && mom_miss.Mag()<pmissUpper && mom_miss.Mag()>pmiss_nomCut
 				  && fid_params.pFiducialCut(mom_lead)&& p_points_to_EC_fid(mom_lead,vtxZ[0],10.)&& mom_lead.Mag()<1.95){
 		  ...
 		  if (p_over_q_sm>pq_min && p_over_q_sm<pq_max_n && mmissSmear<mmiss_nomCut_n && xB>xb_cut && mom_missSmear.Mag()<pmissUpper && mom_missSmear.Mag()>pmissSRC_nomCut_n
 				  &&fid_params.pFiducialCut(mom_smear)&& p_points_to_EC_fid(mom_smear,vtxZ[0],10.)&& mom_smear.Mag()<1.95 ){
  ...
  for (int event =0 ; event < intree->GetEntries() ; event++)
       ...
       if (leadingID > 0)
 	{
 	 ...
 	 //select the 3He neutron sample
 		  if (p_over_q>pq_min && p_over_q<pq_max_n && mmiss<mmiss_nomCut_n && xB>xb_cut && mom_miss.Mag()<pmissUpper && mom_miss.Mag()>pmissSRC_nomCut_n){

 		    h_emom[0][2]->Fill(mom_e.Mag(),1./n_eff); 
 		    h_etheta[0][2]->Fill(mom_e.Theta()*180./M_PI,1./n_eff);
 		    h_q2[0][2]->Fill(QSq,1./n_eff);
 		    h_nu[0][2]->Fill(Nu,1./n_eff);
 		    h_xb[0][2]->Fill(xB,1./n_eff);
 		    h_pmiss[0][2]->Fill(mom_miss.Mag(),1./n_eff);
 		    h_emVpm[0][2]->Fill(mom_miss.Mag(),emiss,1./n_eff);
 		    h_thetapq[0][2]->Fill(mom_lead.Angle(q)*180./M_PI,1./n_eff);
 		    h_nmom[0][2]->Fill(mom_lead.Mag(),1./n_eff);
 		    h_ntheta[0][2]->Fill(theta,1./n_eff);
 		    h_emiss[0][2]->Fill(emiss,1./n_eff);
 		    h_mmiss[0][2]->Fill(mmiss,1./n_eff);
        ...
        if (leadingID > 0)
  	{
  	 ...
  	 if (p_over_q>pq_min && p_over_q<pq_max_p && mmiss<mmiss_nomCut && xB>xb_cut && mom_miss.Mag()<pmissUpper && mom_miss.Mag()>pmiss_nomCut
  		  ...
  		  //select the 4He smeared proton sample			 
  			 if (p_over_q_sm>pq_min && p_over_q_sm<pq_max_n && mmissSmear<mmiss_nomCut_n && xB>xb_cut && mom_missSmear.Mag()<pmissUpper && mom_missSmear.Mag()>pmissSRC_nomCut_n
  			 				  &&fid_params4He.pFiducialCut(mom_smear)&& p_points_to_EC_fid(mom_smear,vtxZ[0],10.)&& mom_smear.Mag()<1.95){
	...
	gRandom->SetSeed(4357);
	 ...
	 double p_eff = myMapC.get_acc(mom_lead);
   	 ...
   	 //select the 12C proton sample
   		  if (p_over_q>pq_min && p_over_q<pq_max_p && mmiss<mmiss_nomCut && xB>xb_cut && mom_miss.Mag()<pmissUpper && mom_miss.Mag()>pmiss_nomCut
   				 && fid_paramsC.pFiducialCut(mom_lead)&& p_points_to_EC_fid(mom_lead,vtxZ[0],10.)&& mom_lead.Mag()<1.95){
   		  ...
   		  if (p_over_q_sm>pq_min && p_over_q_sm<pq_max_n && mmissSmear<mmiss_nomCut_n && xB>xb_cut && mom_missSmear.Mag()<pmissUpper && mom_missSmear.Mag()>pmissSRC_nomCut_n
   				  &&fid_paramsC.pFiducialCut(mom_smear)&& p_points_to_EC_fid(mom_smear,vtxZ[0],10.)&& mom_smear.Mag()<1.95){
  ...
  double kstat = h_emom[0][1]->KolmogorovTest(h_emom[0][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_etheta[0][1]->KolmogorovTest(h_etheta[0][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_q2[0][1]->KolmogorovTest(h_q2[0][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_nu[0][1]->KolmogorovTest(h_nu[0][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_xb[0][1]->KolmogorovTest(h_xb[0][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_pmiss[0][1]->KolmogorovTest(h_pmiss[0][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_thetapq[0][1]->KolmogorovTest(h_thetapq[0][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_nmom[0][1]->KolmogorovTest(h_nmom[0][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_ntheta[0][1]->KolmogorovTest(h_ntheta[0][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_emiss[0][1]->KolmogorovTest(h_emiss[0][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_mmiss[0][1]->KolmogorovTest(h_mmiss[0][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_emom[1][1]->KolmogorovTest(h_emom[1][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_etheta[1][1]->KolmogorovTest(h_etheta[1][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_q2[1][1]->KolmogorovTest(h_q2[1][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_nu[1][1]->KolmogorovTest(h_nu[1][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_xb[1][1]->KolmogorovTest(h_xb[1][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_pmiss[1][1]->KolmogorovTest(h_pmiss[1][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_thetapq[1][1]->KolmogorovTest(h_thetapq[1][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_nmom[1][1]->KolmogorovTest(h_nmom[1][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_ntheta[1][1]->KolmogorovTest(h_ntheta[1][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_emiss[1][1]->KolmogorovTest(h_emiss[1][2]);
  cout<<"kstat: "<<kstat<<endl;
  ...
  kstat = h_mmiss[1][1]->KolmogorovTest(h_mmiss[1][2]);
  cout<<"kstat: "<<kstat<<endl;
